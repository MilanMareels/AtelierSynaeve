...
export default function CreativePage() {
  const creativeProjects = [
    <div key="1" className="relative w-full h-37.5 md:h-87.5 flex justify-center items-center">
    ...
    <div key="2" className="relative w-full h-50 md:h-112.5">
      <Link
    ...
    <div key="3" className="relative w-full h-45 md:h-125 flex justify-center items-center">
    ...
    <div key="4" className="relative w-full h-62.5 md:h-137.5">
      <Link
